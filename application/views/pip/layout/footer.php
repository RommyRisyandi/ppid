 <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019.</strong> Dinas Komunikasi dan Informatika Kota Singkawang
  </footer>
...
<script type="text/javascript">
  CKEDITOR.replace('informasi_diminta');
  CKEDITOR.add
</script>
...
<script type="text/javascript">
  CKEDITOR.replace('alamat_p');
  CKEDITOR.add
</script>

<script type="text/javascript">
  CKEDITOR.replace('alamat_kp');
  CKEDITOR.add
</script>
<!-- /EndCKEditor -->
<!-- Print -->
