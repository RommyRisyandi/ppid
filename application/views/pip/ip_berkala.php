        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h2 class="box-title">Daftar Informasi Publik Secara Berkala</h2>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <a href="<?php echo site_url('pip/cetak_berkala'); ?>"><button class="btn btn-danger"><i class="fa fa-print"></i> Cetak Informasi</button></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
