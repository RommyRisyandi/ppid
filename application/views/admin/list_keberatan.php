        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h2 class="box-title">Daftar Pernyataan Keberatan</h2>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tr>
                 ...
                 <td><a href="<?php echo site_url('admin/diterima2/').$r->id_keberatan;?>"><button class="btn btn-success btn-xs"><i class="fa fa-check"></i> Terima</button></a><a href="<?php echo site_url('admin/ditolak2/').$r->id_keberatan;?>"><button class="btn btn-danger btn-xs"><i class="fa fa-close"></i> Tolak</button></a></td>
                </tr>
                <?php } ?>
              </tbody>
              </table>
