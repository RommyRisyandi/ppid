        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h2 class="box-title">Daftar Pernyataan Keberatan yang Diterima</h2>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tr>
                 ...
                 <td><a href="<?php echo site_url('admin/v_keberatan/').$r->id_keberatan?>"><button class="btn btn-primary btn-xs"><i class="fa fa-print"></i> Cetak</button></a></td>
                </tr>
                <?php } ?>
              </tbody>
              </table>
